    ...
    <body>
        ...
        <div class="container">
			...
			<header>
				 ...
				 <h1><p> <a href="Sign In.php"><img src="images/logo.png" alt="" /> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>Fonswa<br><strong>Login Form<br></strong> <span>Please Login Or Sign Up </span></p> </h1>
                        ...
                        <div id="login" class="animate form">
                            <form  action="userValidate.php" method="post" autocomplete="on">
                                ...
                                <p>
                                    ...
                                    <input type="text" name="magaca" required="required" type="text" placeholder="example@gmail.com"/>
                                </p>
                                <p>
                                    <label for="password" class="youpasswd" data-icon="p"> Your Password </label>
                                    <input type="password" name='furaha' required="required" type="password" placeholder="password" />
                                </p>
                                <p class="keeplogin">
