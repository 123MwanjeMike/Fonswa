  ...
  {?>
   ...
   <tr>
	...
	<label>Category:</label>
		...
		<input type="text" id="cname" name="cname" value="<?php echo $row['Category_Name'];?>" placeholder="User name" required>
		<span class="error">This is an error</span>
	</td>
   ...
   <td>
		...
		<label>Picture:</label>
		<input type="file" name="picture" id="picture"  value="<?php echo $row['Picture'];?>" placeholder="User name" required>
		<span class="error">This is an error</span>
