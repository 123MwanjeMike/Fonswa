...
<div id="container">
	   ...
	   <div id="header">
		...
		<div id="logo-banner">
				...
				<h1>Fonswa Electricals and Electronics</h1>
				</div>
	...
	<section id="secondary_bar">
            ...
            <nav><!-- Defining the navigation menu -->
                <ul>
                    ...
                    <li class="logout"> <span class="check"> <?php echo "Welcome:   ". "<font color='##fa5400'><i><b>".$login_session."</b></i></font>" ;?> </span></li>
...
<aside id="sidebar" class="column">
	...
	<section id="main" class="column">
		...
		<h4 class="alert_info">Welcome To <strong>"Fonswa"</strong> Admin Panel As: <?php echo "  ". "<font color='#f90'><big><b>".$login_session."</b></big></font>" ;?>  </h4>
...
<?php while($row = mysqli_fetch_array($result))
  ...
  <?php }mysqli_close($mysqli);?>
	     ...
	     <div class="shout_box">
            <div class="header"> live Discussion of Fonswa Electricals and Electronics <div class="close_btn">&nbsp;</div></div>
