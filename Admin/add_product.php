...
<aside id="sidebar" class="column">
	...
	<h4 class="alert_info">Welcome To <strong>"Fonswa Electricals $ Electronics"</strong> Admin Panel As: <?php echo "  ". "<font color='#f90'><big><b>".$login_session."</b></big></font>" ;?>  </h4>
...
<SCRIPT language="Javascript">
      ...
      function isNumberKey(evt)
      {
         ...
         var charCode = (evt.which) ? evt.which : event.keyCode
		  window.alert("Only numbers allowed in the Price field!!!");
...
?>
  ...
  <table class="tablesorter" cellspacing="0">
			...
			<thead>  <th Colspan="11">  Fonswa Product Data Table </th></thead>
		<thead>
			</tr>
   		      <th>Check</th>
    	      <th>ID</th>
