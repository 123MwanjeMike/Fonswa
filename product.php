		...
		<div class="container">
			<div class="row">
                ...
                <?php
                  ...
                  // WHERE productName LIKE '%{$product}%' OR Description LIKE '%{$product}%'";
									$results = $mysqli->query("SELECT * FROM product WHERE productName LIKE '%{$product}%' OR Description LIKE '%{$product}%' ORDER BY Product_ID ASC");
									if ($results) {
